...
def update_boundary(
    ...
    classroom.latitude_min = payload.latitude_min
    classroom.latitude_max = payload.latitude_max
    classroom.longitude_min = payload.longitude_min
    classroom.longitude_max = payload.longitude_max
    db.commit()
    db.refresh(classroom)
