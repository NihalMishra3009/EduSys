...
class AppColors {
  ...
  static const Color lightSecondary = Color(0xFF56CCF2);
  static const Color lightBackground = Color(0xFFF6F9FC);
  static const Color lightSurface = Color(0xFFFFFFFF);
  static const Color lightSurfaceSoft = Color(0xFFF0F4F8);
  static const Color lightTextPrimary = Color(0xFF1A1A1A);
  static const Color lightTextSecondary = Color(0xFF5F6C7B);
  static const Color lightTextDisabled = Color(0xFFA0A7B1);
  ...
  static const Color lightTabInactive = Color(0xFFA0A7B1);
  static const Color lightTabActiveBg = Color(0x1A2F80ED);
